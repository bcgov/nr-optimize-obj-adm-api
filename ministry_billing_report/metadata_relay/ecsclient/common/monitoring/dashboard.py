...
class Dashboard(object):
    ...
    def get_storage_pool(self, storage_pool_id):
        ...
        return self.conn.get(url="dashboard/storagepools/{0}".format(storage_pool_id))
    ...
    def get_node(self, node_id):
        ...
        return self.conn.get(url="dashboard/nodes/{0}".format(node_id))
    ...
    def get_disk(self, disk_id):
        ...
        return self.conn.get(url="dashboard/disks/{0}".format(disk_id))
    ...
    def get_process(self, process_id):
        ...
        return self.conn.get(url="dashboard/processes/{0}".format(process_id))
    ...
    def get_node_processes(self, node_id):
        ...
        return self.conn.get(url="dashboard/nodes/{0}/processes".format(node_id))
    ...
    def get_node_disks(self, node_id):
        ...
        return self.conn.get(url="dashboard/nodes/{0}/disks".format(node_id))
    ...
    def get_local_zone_replication_group_bootstrap_links(self):
        ...
        return self.conn.get(url="dashboard/zones/localzone/rglinksBootstrap")
    ...
    def get_replication_group_links(self, replication_group_id):
        ...
        return self.conn.get(
            url="dashboard/replicationgroups/{0}/rglinks".format(replication_group_id)
        )
