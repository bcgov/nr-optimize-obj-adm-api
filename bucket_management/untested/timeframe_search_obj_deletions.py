...
Description:
    ...
    optionally scoped by BUCKET_PATH_PREFIX. Enhances original script by retrieving:
...
BUCKET_PATH_PREFIX = os.getenv("BUCKET_PATH_PREFIX")  # <-- New: prefix support
...
if BUCKET_PATH_PREFIX:
    pagination_args["Prefix"] = BUCKET_PATH_PREFIX
