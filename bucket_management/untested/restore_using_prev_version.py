...
Inputs
------
- .env: ACCESS_KEY, SECRET_KEY, S3_ENDPOINT, BUCKET_NAME (optional), OUTPUT_PATH (optional)
...
- Accepted header variants (case-insensitive):
  ...
  * Bucket -> "bucket"
- If BUCKET_NAME is omitted in .env, you must provide a Bucket value per row.
...
def restore_from_xlsx(s3, cfg, input_xlsx, output_xlsx, input_sheet=None, report_sheet="Report", dry_run=False):
    ...
    for idx, row in df.iterrows():
        ...
        bucket = row_bucket or cfg.get("BUCKET_NAME", "")
