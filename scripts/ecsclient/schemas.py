WHOAMI = {
    ...
    "properties": {
        ...
        "last_time_password_changed": {"type": "string", "format": "date-time"},
...
LINK = {
    "type": "object",
    "properties": {"rel": {"type": "string"}, "href": {"type": "string"}},
    "required": ["rel", "href"],
}
...
NAMESPACE = {
    ...
    "properties": {
        ...
        "is_encryption_enabled": {
            "type": ["string", "boolean"]
        },  # Workaround: The API returns a string instead of
        # a boolean
...
LICENSE = {
    ...
    "required": ["license_feature", "license_text"],
}
...
STORAGE_POOL = {
    ...
    "required": ["id", "name", "isProtected", "isColdStorageEnabled"],
}

STORAGE_POOLS = {
    "type": "object",
    "properties": {"varray": {"type": "array", "minItems": 1, "items": STORAGE_POOL}},
    "required": ["varray"],
}
...
VDCS = {
    "type": "object",
    "properties": {"vdc": {"type": "array", "minItems": 1, "items": VDC}},
    "required": ["vdc"],
}
    ...
    "properties": {
        "data_store": {
            ...
            "items": {
                ...
                "required": ["id", "name", "resource_type", "link"],
            },
        }
    },
    "required": ["data_store"],
...
DATA_STORES_COMMODITY = {
    "type": "object",
    "properties": {
        "commodity_data_store": {"type": "array", "minItems": 1, "items": DATA_STORE}
    },
    "required": ["commodity_data_store"],
}
...
DATA_STORE_TASKS = {
    "type": "object",
    "properties": {"task": {"type": "array", "minItems": 1, "items": DATA_STORE_TASK}},
    "required": ["task"],
}
...
OBJECT_USER = {
    ...
    "required": ["name", "created", "namespace", "locked"],
}
...
OBJECT_USERS = {
    "type": "object",
    "properties": {
        "blobuser": {"type": "array", "minItems": 0, "items": OBJECT_USER_2},
        "Filter": {"type": "string"},
    },
    "required": ["blobuser"],
}
...
SECRET_KEYS = {
    ...
    "required": ["secret_key_1", "secret_key_2", "key_timestamp_1", "key_timestamp_2"],
}
...
SECRET_KEY = {
    ...
    "required": ["secret_key", "key_timestamp", "key_expiry_timestamp", "link"],
}
...
BUCKET_SHORT = {
    ...
    "properties": {
        ...
        "metaData": {
            ...
            "required": ["search_enabled", "max_keys", "metadata"],
        },
        "remote": {"type": ["boolean", "null"]},
        "name": {"type": "string"},
    },
    "required": ["TagSet", "global", "vdc", "inactive", "metaData", "remote", "name"],
}
...
BUCKET_LIST = {
    "type": "object",
    "properties": {
        "object_bucket": {"type": "array", "minItems": 0, "items": BUCKET},
        "Filter": {"type": "string"},
        "MaxBuckets": {"type": "number"},
    },
    "required": ["object_bucket", "Filter", "MaxBuckets"],
}
...
BUCKET_ACL_PERMISSIONS = {
    "type": "object",
    "properties": {"permission": BUCKET_ACL},
    "required": ["permission"],
}

BUCKET_ACL_GROUPS = {
    "type": "object",
    "properties": {"group": BUCKET_ACL},
    "required": ["group"],
}
...
MANAGEMENT_USER = {
    ...
    "required": ["userId", "isSystemAdmin", "isSystemMonitor", "is_external_group"],
}

MANAGEMENT_USERS = {
    "type": "object",
    "properties": {
        "mgmt_user_info": {"type": "array", "minItems": 0, "items": MANAGEMENT_USER},
    },
    "required": ["mgmt_user_info"],
}
...
NODE = {
    ...
    "required": ["rackId", "version", "nodeid", "isLocal", "nodename", "ip"],
}

NODE_LIST = {
    "type": "object",
    "properties": {
        "node": {"type": "array", "items": NODE, "minItems": 1, "uniqueItems": True}
    },
    "required": ["node"],
}
...
ALERTS = {
    ...
    "required": ["MaxAlerts", "Filter", "alert"],
}
...
CAPACITY = {
    ...
    "required": ["totalFree_gb", "totalProvisioned_gb"],
}
