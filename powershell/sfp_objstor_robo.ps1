...
# copy folder-only hierarchy from source to destination
$source = "C:\Users\HHAY\OneDrive - Government of BC\Optimization" # change these later to be input prompts
$dest = "C:\TEMP"
