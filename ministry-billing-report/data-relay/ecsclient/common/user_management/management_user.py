...
class ManagementUser(object):
    ...
    def create(self, user_id, password, is_system_admin=False, is_system_monitor=False):
        """
    ...
    def update(self, user_id, password, is_system_admin=False, is_system_monitor=False):
        """
        ...
        return self.conn.put(url="vdc/users/{}".format(user_id), json_payload=payload)
