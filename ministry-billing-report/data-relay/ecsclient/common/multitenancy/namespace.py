...
class Namespace(object):
    ...
    def get(self, namespace):
        ...
        return self.conn.get(url="object/namespaces/namespace/{0}".format(namespace))
    ...
    def create(
        ...
        default_bucket_block_size=None,
        allowed_vpools_list=[],
        disallowed_vpools_list=[],
        namespace_admins=None,
        external_group_admins=None,
        user_mapping=[],
    ...
    def update(
        ...
        return self.conn.put(
            "object/namespaces/namespace/{}".format(namespace_id), json_payload=payload
        )
    ...
    def delete(self, namespace_id):
        ...
        return self.conn.post(
            "object/namespaces/namespace/{}/deactivate".format(namespace_id)
        )
    ...
    def get_retention_class(self, name, namespace):
        ...
        return self.conn.get(
            url="object/namespaces/namespace/{0}/retention/{1}".format(namespace, name)
        )
    ...
    def create_retention_class(self, name, period, namespace):
        ...
        to be created.
        """
        payload = {"name": name, "period": period}
    ...
    def update_retention_class(self, name, period, namespace):
        ...
        log.info(
            "Updating retention '{0}' in ns {1}: {2}".format(name, namespace, payload)
        )
        return self.conn.put(
            url="object/namespaces/namespace/{0}/retention/{1}".format(namespace, name),
            json_payload=payload,
    ...
    def update_namespace_quota(self, block_size, notification_size, namespace):
        ...
        log.info("Updating quota for namespace '{0}': {1}".format(namespace, payload))
        return self.conn.put(
            url="object/namespaces/namespace/{0}/quota".format(namespace),
            json_payload=payload,
        )
