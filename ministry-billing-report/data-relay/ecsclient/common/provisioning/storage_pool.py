...
class StoragePool(object):
    ...
    def create(
        self, name, description=None, is_protected=False, is_cold_storage_enabled=False
    ):
        """
    ...
    def update(self, storage_pool_id, name=None, is_protected=None):
        ...
        :param is_protected: Set to True to enable storage pool protection, False otherwise
        """
        payload = {"name": name, "isProtected": is_protected}
        ...
        return self.conn.put(
            "vdc/data-services/varrays/{}".format(storage_pool_id), json_payload=payload
        )
