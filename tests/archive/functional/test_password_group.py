...
class TestPasswordGroup(functional.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.client.password_group.create(
            self.object_user_1,
            self.password_1,
            self.groups_list_1,
    ...
    def tearDown(self):
        ...
        for object_user in [self.object_user_1, self.object_user_2]:
            try:
    ...
    def test_password_group_create_for_user(self):
        self.client.password_group.create(
            user_id=self.object_user_2,
            namespace=self.namespace_1,
            password=self.password_2,
            groups_list=self.groups_list_2,
        )

        response = self.client.password_group.get(
            user_id=self.object_user_2, namespace=self.namespace_1
        )
    ...
    def test_password_group_get_by_user(self):
        response = self.client.password_group.get(
            user_id=self.object_user_1, namespace=self.namespace_1
        )
    ...
    def test_password_group_update_for_user(self):
        ...
        self.client.password_group.update(
            user_id=self.object_user_1,
            namespace=self.namespace_1,
            password=self.password_2,
            groups_list=self.groups_list_2,
        )
    ...
    def test_password_group_delete_for_user(self):
        self.client.password_group.delete(
            user_id=self.object_user_1, namespace=self.namespace_1
        )
