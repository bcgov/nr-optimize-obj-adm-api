...
class TestReplicationGroup(functional.BaseTestCase):
    ...
    def tearDown(self):
        ...
        for replication_group_id in [
            self.replication_group_1_id,
    ...
    def test_replication_group_update(self):
        ...
        self.client.replication_group.update(
            self.replication_group_1_id,
            name=new_name,
    ...
    def test_replication_group_create(self):
        zone_mappings = [(self.vdc_1_id, self.storage_pool_1_id)]
        response = self.client.replication_group.create(
            self.replication_group_2,
            zone_mappings,
        ...
        self.assertEqual(
            response["description"], self.replication_group_2 + " description"
        )
        self.assertFalse(response["isAllowAllNamespaces"])
