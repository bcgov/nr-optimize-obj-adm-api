...
class ReplicationGroup(object):
    ...
    def update(
        ...
        return self.conn.put(
            "vdc/data-service/vpools/{}".format(replication_group_id),
    ...
    def delete(self, replication_group_id):
        ...
        return self.conn.post(
            "vdc/data-service/vpools/{}/deactivate".format(replication_group_id)
        )
    ...
    def add_storage_pool(self, replication_group_id, vdc_id, storage_pool_id):
        ...
        """
        payload = {"mappings": [{"name": vdc_id, "value": storage_pool_id}]}
        log.info(
            "Adding the storage pool '{}' to the replication group '{}'".format(
                storage_pool_id, replication_group_id
            )
        )
        return self.conn.put(
            "vdc/data-service/vpools/{}/addvarrays".format(replication_group_id),
            json_payload=payload,
        )
    ...
    def remove_storage_pool(self, replication_group_id, vdc_id, storage_pool_id):
        ...
        payload = {"mappings": [{"name": vdc_id, "value": storage_pool_id}]}
        log.info(
            "Removing the storage pool '{}' from the replication group '{}'".format(
                storage_pool_id, replication_group_id
            )
        )
        return self.conn.put(
            "vdc/data-service/vpools/{}/removevarrays".format(replication_group_id),
            json_payload=payload,
        )
